...
| [`tannor-1993-jcp98-3884.md`](tannor-1993-jcp98-3884.md) | D. J. Tannor, D. E. Weeks, *Wave packet correlation function formulation of scattering theory*, J. Chem. Phys. **98**, 3884 (1993). [DOI](https://doi.org/10.1063/1.464016) | **The most-cited external source in the repo.** The correlation-function energy transform behind every TD cross section. |
