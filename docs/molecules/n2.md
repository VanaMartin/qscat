...
- These ranges are bands over the 11 recorded energies, not over every
  ...
  them further (§9 of {doc}`../physics/nrm-vibrational-excitation` quantifies it).
...
{doc}`../physics/nrm-vibrational-excitation`.
...
The nonlocal resonance model: {doc}`../physics/nonlocal-resonance-model`, and its
vibrational-excitation route: {doc}`../physics/nrm-vibrational-excitation`. The three
